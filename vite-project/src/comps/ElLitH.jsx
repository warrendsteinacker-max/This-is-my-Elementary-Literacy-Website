...
const ElLitH = () => {
  return (
    ...
    <div style={{fontFamily: 'Georgia'}}>
        ...
        <div>
            <p style={{color: 'black'}}>This website is a comprehensive overview that documents the literacy training process covered in Elementary Literacy. It tracks the progression from the synthesis of assignments across distinct Modules.</p>
        </div>
    </div>
    </>
  )
